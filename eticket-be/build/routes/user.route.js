...
userRouter.get("/refresh-token", user_controllers_1.updateAccessToken);
...
userRouter.put("/update-user", auth_1.isAuthenticated, user_controllers_1.socialAuth);
userRouter.put("/change-password", auth_1.isAuthenticated, user_controllers_1.changePassword);
